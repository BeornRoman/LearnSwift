...
let newBest = 15125
let congratulation: String = "Congratulations, \(fullname)! You beat your previous daily high score of \(previousBest) steps by walking \(newBest) steps yesterday!"
